...
class ScreenAccountManager extends StatefulWidget {
  String title;
  String initialUrl;
  ScreenAccountManager({required this.title,required this.initialUrl,});

  @override
  _ScreenAccountManagerState createState() => _ScreenAccountManagerState();
}
late WebViewController _webViewController3;
class _ScreenAccountManagerState extends State<ScreenAccountManager> {
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: ListTile(
                      ...
                      onTap: () async {
                        await _webViewController3.loadUrl("https://safestore.tech/ad/iphone-13-gorilla-glass-128-gb-dual-sim/");
                  ...
                  Padding(
                    ...
                    child: ListTile(
                      ...
                      onTap: () async {
                        await  _webViewController3.loadUrl("https://safestore.tech");
                        Navigator.pop(context);
                      },
                    ),
                  ),
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(onPressed: () async {
            setState(() {
              isLoading=true;
              _webViewController3.reload();
            });
          }, icon: Icon(Icons.refresh),),
          IconButton(onPressed: () async {
            if (await _webViewController3.canGoBack()) {
              _webViewController3.goBack();
            }
          }, icon: Icon(Icons.arrow_back,color: (bac==false)?Colors.grey:Colors.black,),),
          IconButton(onPressed: () async {
            if (await _webViewController3.canGoForward()) {
              _webViewController3.goForward();
            }
          ...
          child: Stack(
              children: [
                WillPopScope(
                  onWillPop: () async {
                    if (await _webViewController3.canGoBack()) {
                      await _webViewController3.goBack();
                      return false;
                    }
                    return true;
                  },
                  child: WebView(
                    ...
                    onWebViewCreated: (WebViewController controller) async {
                      _webViewController3 = controller;
                    },

...
class ScreenItmanager extends StatefulWidget {
  String title;
  String initialUrl;
  ScreenItmanager({required this.title,required this.initialUrl,});

  @override
  _ScreenItmanagerState createState() => _ScreenItmanagerState();
}
late WebViewController _webViewController5;
class _ScreenItmanagerState extends State<ScreenItmanager> {
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: ListTile(
                      ...
                      onTap: () async {
                        await _webViewController5.loadUrl("https://safestore.tech/ad/iphone-13-gorilla-glass-128-gb-dual-sim/");
                  ...
                  Padding(
                    ...
                    child: ListTile(
                      ...
                      onTap: () async {
                        await  _webViewController5.loadUrl("https://safestore.tech");
                        Navigator.pop(context);
                      },
                    ),
                  ),
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(onPressed: () async {
            setState(() {
              isLoading=true;
              _webViewController5.reload();
            });
          }, icon: Icon(Icons.refresh),),
          IconButton(onPressed: () async {
            if (await _webViewController5.canGoBack()) {
              _webViewController5.goBack();
            }
          }, icon: Icon(Icons.arrow_back,color: (bac==false)?Colors.grey:Colors.black,),),
          IconButton(onPressed: () async {
            if (await _webViewController5.canGoForward()) {
              _webViewController5.goForward();
            }
          ...
          child: Stack(
              children: [
                WillPopScope(
                  onWillPop: () async {
                    if (await _webViewController5.canGoBack()) {
                      await _webViewController5.goBack();
                      return false;
                    }
                    return true;
                  },
                  child: WebView(
                    ...
                    onWebViewCreated: (WebViewController controller) async {
                      _webViewController5 = controller;
                      _webViewController5.runJavascript("document.getElementById('header04-2j').style.display = 'none';");
                    },
